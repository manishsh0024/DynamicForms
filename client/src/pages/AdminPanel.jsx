                ...
                >
                  ...
                  <div className="flex gap-5 flex-wrap justify-center sm:justify-start">
                    ...
                    <button
                      ...
                      title="Edit"
                      className="flex items-center justify-center bg-blue-500 text-white p-3 rounded-xl hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 transition duration-300"
                    >
                      {/* Pencil Icon */}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <button
                      ...
                      title="Delete"
                      className="flex items-center justify-center bg-rose-500 text-white p-3 rounded-xl hover:bg-rose-600 focus:outline-none focus:ring-4 focus:ring-rose-300 transition duration-300"
                    >
                      {/* Trash Icon */}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
